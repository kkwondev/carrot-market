    ...
    <div className="py-16 space-y-8 px-4">
      {[...Array(10)].map((_, i) => (
        <div key={i} className="flex flex-col items-start cursor-pointer">
          ...
          <div className="mt-5 flex ite ms-center justify-between w-full text-gray-500 font-medium text-xs">
            <span>경원</span>
            <span>18시간 전</span>
          </div>
      ...
      <button className="fixed bottom-24 right-5 shadow-xl bg-orange-400 rounded-full p-3 text-white hover:bg-orange-500 cursor-pointer transition-colors">
        <svg
          className="w-6 h-6"
          fill="none"
          stroke="currentColor"
